...
<header class="main-nav">
    ...
    <div class="sidebar-user text-center">
        ...
        <div class="user-info">
            <span>
                <img src="{{asset('assets/images/sidebar/apoyo.png')}}" width=30 height=30 style='border-width: 0px;' alt="" />
                Espónsor
            </span>
            <span>
                <img src="{{asset('assets/images/sidebar/espana.png')}}" width=30 height=30 style='border-width: 0px;' alt="" />
                Espanol
            </span>
        </div>
        <div class="avail-bal">
        ...
        <div class="benefit">
            <span>Ganancias (7d)</span>
            <span>
                <bold>+808.08</bold> USD
            </span>
        ...
        <!--    <label style="padding-top: 5px; padding-left: 8px; font-weight: bold;">Interes Compuesto</label>-->
        <!--</div>-->
    </div>
    <nav>
        <div class="main-navbar">
            ...
            <div id="mainnav">
                <ul class="nav-menu custom-scrollbar" style="margin-top: -16px;">
                    <!--<li>-->
                    ...
                    <!--    <a href="{{route('index')}}" class="nav-link menu-title link-nav {{routeActive('index')}}"><i data-feather="home"></i><span>Tablero</span></a>-->
                    <!--</li>-->
                    <!--<li class="dropdown">-->
                    <!--    <a class="nav-link menu-title {{ prefixActive('/dashboard1') }}" href="javascript:void(0)">-->
                            <!--<i data-feather="layout"></i>-->
                    <!--        <img src="{{asset('assets/images/sidebar/equipo.png')}}" class="img-20" height="20px" alt="" />&nbsp;&nbsp;-->
                    <!--        <span>Sobre Nosotros</span></a>                  -->
                    <!--    <ul class="nav-submenu menu-content" style="display: {{ prefixBlock('/dashboard1') }};">-->
                            <!--<li><a href="{{route('index')}}" class="{{routeActive('index')}}">Default</a></li>-->
                    <!--        <li><a href="{{route('dashboard-02')}}" class="{{routeActive('dashboard-02')}}">Comercio Electronico</a></li>-->
                    <!--    </ul>-->
                    <!--</li>-->
                    <!--<li class="dropdown">-->
                    <!--    <a class="nav-link menu-title {{ prefixActive('/widgets') }}" href="javascript:void(0)"><i data-feather="airplay"></i><span>Información General</span></a>-->
                    <!--    <ul class="nav-submenu menu-content"  style="display: {{ prefixBlock('/widgets') }};">-->
                    <!--        <li><a href="{{ route('general-widget') }}" class="{{routeActive('general-widget')}}">Ajuste</a></li>-->
                    <!--        <li><a href="{{route('refferal')}}" class="{{routeActive('refferal')}}">Referencias</a></li>-->
